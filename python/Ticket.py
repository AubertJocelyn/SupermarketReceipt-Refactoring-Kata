...
class Ticket:
    ...
    products_quantities_to_obtain: Dict[Product, float]
    def __init__(self, start_valididy, end_validity, min_products_quantities, max_products_quantities, products_quantities_to_obtain):
        ...
        self.products_quantities_to_obtain = products_quantities_to_obtain

    def is_ticket_obtain(self, products, quantities):
        return all(products[i] in self.products_quantities_to_obtain.keys()\
               and quantities[i] >= self.products_quantities_to_obtain[products[i]]\
